...
import protect, { isAdmin, requireSignIn } from "../middleware/authMiddleware.js";
...
import getMonthlySales from "../controllers/user/getMonthlySales.js";
...
router.get("/getMonthlySales", protect, getMonthlySales);
